...
╭─ 📍 Route to 8.8.8.8 ────────────────────────────────────────────────────────╮
│  #   RTT (min/avg/max)    IP               Status  ASN       Location     ...│
│ ─────────────────────────────────────────────────────────────────────────────│
│  1   1 / 2 / 3            192.168.1.1      🏠      -         -               │
│  2   5 / 6 / 8            100.64.0.1       🔒      -         -               │
│  3   * / * / *            -                ⚠️      -         -               │
│  4   12 / 14 / 15         202.97.94.1              AS4134    🇨🇳 CN          │
│ ...                                                                          │
╰──────────────────────────────────────────────────────────────────────────────╯
...
If you use multiple GitHub accounts, configure your `~/.ssh/config`:
...
Then clone using the alias: `git clone git@github-work:username/repo.git`
